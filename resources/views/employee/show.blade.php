            ...
            <div class="p-5 bg-light rounded-3 col-xl-4 border">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        @else
                            <h5>Tidak ada</h5>
                            <a href="{{ route('employees.editCV', ['employeeId' => $employee->id]) }}" class="btn btn-info btn-sm mt-2">
                            ...
                            <div class="col-md-12 d-grid">
                                ...
                                <a href="{{ route('employees.confirmDelete', ['employeeId' => $employee->id]) }}" class="btn btn-danger btn-lg mt-3">
